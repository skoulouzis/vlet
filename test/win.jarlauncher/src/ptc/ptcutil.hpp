...
// 
// ----------------------------------------------------------------
// The following headers are auto generated from: ptcutil.cpp to: ptcutil.hpp 
// ----------------------------------------------------------------
// 
/**
 * (C) Piter.nl 2010 (http://www.piter.nl/source/ptcutil)
 * File: ptcutil
 * Info:
 * 		P.T.'s C(PP) Stuff
...
/**
 *============================================================================
 *Memory methods: See ptcdefs for alloc/free macro definitions
 *============================================================================
 */
;
 ...
 * @return 1 if it exists,0 if not and <0 if and ERROR occcured
 */
 ...
 */
int Fwrite(const char *file,const void *ptr,size_t size);
