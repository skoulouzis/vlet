...
public class Messages
{
    ...
    public static String aboutText=
        ...
        +"<p>"
        +" <table>"
        +"  <tr><td> For more info mailto:</td>"  + "<td> vlet-users@lists.vl-e.nl </td></tr>"  
        +"  <tr><td> Submit bug reports to:</td>" + "<td> vlet-bugs@lists.vl-e.nl </td></tr>"
        ...
        +"    <tr><td></td><td>Kamel Boulebiar (LFC Wrapper/vlemed)</td></tr>"
