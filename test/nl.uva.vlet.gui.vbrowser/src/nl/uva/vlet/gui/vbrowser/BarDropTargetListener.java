 ...
 * MyTranferHandler is used when a drag is started, but currently 
 * all the 'drops'  are handled by this DropTargetListener.  
 */
...
public  class BarDropTargetListener implements  DropTargetListener//, DragSourceListener,
{
    ...
    {
        Global.debugPrintln("MyDragHandler",string);
    }
