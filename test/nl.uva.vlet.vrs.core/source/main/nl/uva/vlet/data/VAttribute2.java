...
// * a getStringValue() after a setValue(int) will return the string representation 
// * of the integer. 
...
//    {
//        return new VAttribute(VAttributeType.STRING,name,value); 
//    }
//    
