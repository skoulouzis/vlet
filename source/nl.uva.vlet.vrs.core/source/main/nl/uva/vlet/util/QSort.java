...
public class QSort
{
     ...
     * The returned vector (I[]) provides mapping information about the 
     * new order. 
     * The sorted list Y[] equals to the original list X[] as follows:  
     * Y[I[i]] = X[i] 
     * Or:
        ...
        public int compare(Object o1, Object o2)
        {
            ...
            while ((result==0) && (i<n))
            {
                ...
                catch (Exception e)
                {
                    ...
                    //throw new Error("Fatal: Exception while fetching attribute:"+e,e); 
                    return 0; 
                }
