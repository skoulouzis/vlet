...
public class SftpFSFactory extends VFSFactory {
    ...
    // instance
    // ========================================================================
    private String schemeNames[] = {VFS.SFTP_SCHEME, "sshftp"};
    ...
    /**
     * Return authentication information object for this location. The default
     * implementation is to check the Authentication Store. If non is available
     * the default for ssh/sftp is returned.
     */
    @Override
