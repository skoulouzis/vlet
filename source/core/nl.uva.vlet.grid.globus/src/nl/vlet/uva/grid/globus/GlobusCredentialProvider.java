...
public class GlobusCredentialProvider implements VGridCredentialProvider {
    ...
    /**
     * This is a kludge: since some globus applications use the default proxy
     * location, this location needs to be updated in the default proxy
     * staticModel. This way an alternative loaded proxy will still be available
     * as "default". This will only "remember" the latest location a proxy has
     * been loaded from !
     *
     * @param path
     */
