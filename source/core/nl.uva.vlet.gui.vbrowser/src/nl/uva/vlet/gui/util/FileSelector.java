...
/**
 * Class that extend the JDIalog class.
 * It can open a save or open dialog.
 * User has to set the type before to open the dialog.
 *@author kboulebiar
 */
	...
	private void initGUI() {
		 try {
	           ...
	           if(typeDialog==SAVE_DIALOG)
	            ...
	            treeResourceScrollPane.setPreferredSize(new java.awt.Dimension(
	                    300, 300));
	            ...
	            resourceTabbedPane.addTab("Resource", null, treeResourceScrollPane,
	                null);
