 ...
 * ---
 * $Id: CnsChmodResponse.java,v 1.2 2011-04-18 12:30:39 ptdeboer Exp $  
 ...
 */
public class CnsChmodResponse extends AbstractCnsResponse
{
    ...
    public void readFrom(final DataInputStream input) throws IOException
    {
        ...
        if (this.type == CnsConstants.CNS_RC)
        {
            ...
            // we have an error!
            LFCServer
                    .staticLogIOMessage("ERROR: " + LFCError.getMessage(this.size)); //$NON-NLS-1$
        }
    }
