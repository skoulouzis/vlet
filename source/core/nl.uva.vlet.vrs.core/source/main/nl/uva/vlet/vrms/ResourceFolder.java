 ...
 * <p> 
 * Implementation note: this class implements VLogicalResource but 
 * it NOT a LogicalResourceNode which is used as parent for VLinks ! 
 * (Main difference is that ResourceFolder is composite and LogicalNode is singular) 
 */

public class ResourceFolder extends LogicalFolderNode<VNode> 
	implements VCompositePersistance,VEditable,VRenamable,
	VDuplicatable<ResourceFolder>,VDeletable,VCompositeDeletable, VStreamReadable,VPresentable
{
	...
	public void setLogicalParent(VNode node) throws ResourceTypeMismatchException
	{
		if ((node instanceof ResourceFolder)==false) 
				throw new nl.uva.vlet.exception.ResourceTypeMismatchException("ResourceGroups can only have ResourceFolder node as parent. Got:"+node);
	...
	{ 
	    if (isEditable()==false)
	        throw new nl.uva.vlet.exception.ResourceNotEditableException("Cannot add resource to this folder: Read Only folder");
    ...
    throws VlException
    {
		...
		// Currently two concrete types allowed: ResourceFolder and LogicalResourceNode
	...
	/**
	 * Sets logical location of this ResourceFolder, but also updates 
	 * ALL logical location of all of it's children. 
	 */
	...
	public boolean delete(boolean recursive) throws VlException
	{
		...
		Global.infoPrintln(this,"deleting():"+this); 
	...
	private boolean deleteDiscriptionLocation() throws VlException
	{
		if (this.descriptionLocation!=null)
		{
			...
			{
				Global.infoPrintln(this,"deleting description location:"+node); 
	...
	private void setSubNodeLogicalLocation(VLogicalResource node) throws VlException
	{
		if (this.getLocation()==null)
		{
			...
			Global.warnPrintln(this,"setSubNodeLogicalLocation(): No Logical location (yet?) for:"+this);
			return;
		}
	...
	/**
	 * Returns location of XML description of this ResourceFolder 
	 * and all it's children resources.<br> 
	...
	public boolean save() 
	{
		...
		else if (this.descriptionLocation!=null)
		{
			...
			{
				Global.warnPrintln(this,"Couldn't save xml description:"+this);
				debug("Error saving description:"+this);
				debug("Exception="+e);
		...
		else
		{
			...
			if (this.logicalParent!=null)
				Global.warnPrintln(this,"*** Warning: save() called on node which does not have a parent container:"+this);
			else if (this.descriptionLocation==null)
				Global.warnPrintln(this,"*** Warning: save() called on node which does not have a description location:"+this); 
	...
	private void saveToXml() throws VlException
	{
	    ...
	    synchronized(saveMutex)
	    {
	        ...
	        if (loc==null)
	            throw new nl.uva.vlet.exception.ResourceDeletionFailedException("Description Location is NULL of:"+this); 
            ...
            {
                Global.warnPrintln(this,"Warning: Exception when closing:"+this); 
