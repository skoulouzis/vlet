 ...
 */
public class LDir extends nl.uva.vlet.vfs.VDir
	implements VUnixFileAttributes
{
    /** 
     * The local path into the local filesystem,
     * this MIGHT differ from the URI path !
     */ 
